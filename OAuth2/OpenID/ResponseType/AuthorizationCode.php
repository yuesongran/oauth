...
class AuthorizationCode extends BaseAuthorizationCode implements AuthorizationCodeInterface
{
    ...
    public function getAuthorizeResponse($params, $openID = null)
    {
        ...
        $result['query']['code'] = $this->createAuthorizationCode($params['client_id'], $openID, $params['redirect_uri'], $params['scope'], $params['id_token']);
     ...
     * @param mixed $openID - User ID associated with the authorization code
     ...
     */
    public function createAuthorizationCode($client_id, $openID, $redirect_uri, $scope = null, $id_token = null)
    {
        $code = $this->generateAuthorizationCode();
        $this->storage->setAuthorizationCode($code, $client_id, $openID, $redirect_uri, time() + $this->config['auth_code_lifetime'], $scope, $id_token);
